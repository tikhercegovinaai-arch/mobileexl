...
export class ExcelExportService {
    ...
    static async exportToExcel(
        ...
        if (format === 'pdf') {
            return ExcelExportService._exportToPdf(fields, filename, pdfTemplate);
        }
    ...
    private static async _exportToPdf(
        ...
        const html = PDFTemplateService.getTemplate(templateType, fields, {
            title: filename || 'Exelent Extraction Report',
        });
